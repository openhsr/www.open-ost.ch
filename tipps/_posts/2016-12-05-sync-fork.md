...
In diesem Tipp zeige ich am Beispiel vom Repository [openhsr/www.open-ost.ch](https://github.com/openhsr/www.open-ost.ch/), wie du deinen Fork in Sync halten kannst.
...
```bash
$ git clone https://github.com/dein-git-user/www.open-ost.ch.git
$ cd www.open-ost.ch
```
...
```bash
$ git remote -v
origin	https://github.com/dein-git-user/www.open-ost.ch.git (fetch)
origin	https://github.com/dein-git-user/www.open-ost.ch.git (push)
```

Der neue `upstream` Remote wird wie folgt hinzugefügt.

```bash
$ git remote add upstream https://github.com/openhsr/www.open-ost.ch
```
...
origin	https://github.com/dein-git-user/www.open-ost.ch.git (fetch)
origin	https://github.com/dein-git-user/www.open-ost.ch.git (push)
upstream	https://github.com/openhsr/www.open-ost.ch (fetch)
upstream	https://github.com/openhsr/www.open-ost.ch (push)
```
